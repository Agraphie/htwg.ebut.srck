...
/**
 * This is an object that contains data related to the fulfillmentinfoitem_purchase table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="fulfillmentinfoitem_purchase"
 */

public abstract class BaseFulfillmentinfoitemPurchase  implements Serializable {

	public static String REF = "FulfillmentinfoitemPurchase";
	...
	// constructors
	public BaseFulfillmentinfoitemPurchase () {
		initialize();
	}
	 ...
	 */
	public BaseFulfillmentinfoitemPurchase (de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemPurchasePK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemPurchasePK id;
     ...
     * @hibernate.id
     */
	public de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemPurchasePK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemPurchasePK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemPurchase)) return false;
		else {
			de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemPurchase fulfillmentinfoitemPurchase = (de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemPurchase) obj;
			if (null == this.getId() || null == fulfillmentinfoitemPurchase.getId()) return false;
			else return (this.getId().equals(fulfillmentinfoitemPurchase.getId()));
		}
	}
