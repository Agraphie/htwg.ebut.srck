...
/**
 * This is an object that contains data related to the purchaseprice table.
...
public abstract class BasePurchaseprice  implements Serializable {

	public static String REF = "Purchaseprice";
	 ...
	 */
	public BasePurchaseprice (de.htwg_konstanz.ebus.framework.wholesaler.vo.PurchasepricePK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private de.htwg_konstanz.ebus.framework.wholesaler.vo.PurchasepricePK id;
     ...
     * @hibernate.id
     */
	public de.htwg_konstanz.ebus.framework.wholesaler.vo.PurchasepricePK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (de.htwg_konstanz.ebus.framework.wholesaler.vo.PurchasepricePK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof de.htwg_konstanz.ebus.framework.wholesaler.vo.Purchaseprice)) return false;
		else {
			de.htwg_konstanz.ebus.framework.wholesaler.vo.Purchaseprice purchaseprice = (de.htwg_konstanz.ebus.framework.wholesaler.vo.Purchaseprice) obj;
			if (null == this.getId() || null == purchaseprice.getId()) return false;
			else return (this.getId().equals(purchaseprice.getId()));
		}
	}
