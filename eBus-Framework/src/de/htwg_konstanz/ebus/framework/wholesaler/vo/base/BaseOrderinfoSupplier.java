...
/**
 * This is an object that contains data related to the orderinfo_supplier table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="orderinfo_supplier"
 */

public abstract class BaseOrderinfoSupplier  implements Serializable {

	public static String REF = "OrderinfoSupplier";
	...
	public static String PROP_SPECIALTREATMENTCLASSTYPE = "Specialtreatmentclasstype";
	 ...
	 */
	public BaseOrderinfoSupplier (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String specialtreatmentclasstype;
	...
	/**
	 * Return the value associated with the column: specialtreatmentclasstype
	 */
	public java.lang.String getSpecialtreatmentclasstype () {
		return specialtreatmentclasstype;
	}

	/**
	 * Set the value related to the column: specialtreatmentclasstype
	 * @param specialtreatmentclasstype the specialtreatmentclasstype value
	 */
	public void setSpecialtreatmentclasstype (java.lang.String specialtreatmentclasstype) {
		this.specialtreatmentclasstype = specialtreatmentclasstype;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderinfoSupplier)) return false;
		else {
			de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderinfoSupplier orderinfoSupplier = (de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderinfoSupplier) obj;
			if (null == this.getId() || null == orderinfoSupplier.getId()) return false;
			else return (this.getId().equals(orderinfoSupplier.getId()));
		}
	}
