...
/**
 * This is an object that contains data related to the orderitem_customer table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="orderitem_customer"
 */

public abstract class BaseOrderitemCustomer  implements Serializable {

	public static String REF = "OrderitemCustomer";
	 ...
	 */
	public BaseOrderitemCustomer (de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderitemCustomerPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderitemCustomerPK id;
     ...
     * @hibernate.id
     */
	public de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderitemCustomerPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderitemCustomerPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderitemCustomer)) return false;
		else {
			de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderitemCustomer orderitemCustomer = (de.htwg_konstanz.ebus.framework.wholesaler.vo.OrderitemCustomer) obj;
			if (null == this.getId() || null == orderitemCustomer.getId()) return false;
			else return (this.getId().equals(orderitemCustomer.getId()));
		}
	}
