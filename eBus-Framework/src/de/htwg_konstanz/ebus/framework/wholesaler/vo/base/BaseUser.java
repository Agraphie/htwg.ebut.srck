...
/**
 * This is an object that contains data related to the allusers_view table.
...
public abstract class BaseUser  implements Serializable {
	...
	public static String PROP_ROLLE = "Rolle";
	...
	/**
	 * Return the value associated with the column: rolle
	 */
	...
	/**
	 * Set the value related to the column: rolle
	 * @param rolle the rolle value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof de.htwg_konstanz.ebus.framework.wholesaler.vo.User)) return false;
		else {
			de.htwg_konstanz.ebus.framework.wholesaler.vo.User user = (de.htwg_konstanz.ebus.framework.wholesaler.vo.User) obj;
