...
/**
 * This is an object that contains data related to the user_internal table.
...
public abstract class BaseUserInternal  implements Serializable {

	public static String REF = "UserInternal";
	 ...
	 */
	public BaseUserInternal (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof de.htwg_konstanz.ebus.framework.wholesaler.vo.UserInternal)) return false;
		else {
			de.htwg_konstanz.ebus.framework.wholesaler.vo.UserInternal userInternal = (de.htwg_konstanz.ebus.framework.wholesaler.vo.UserInternal) obj;
			if (null == this.getId() || null == userInternal.getId()) return false;
			else return (this.getId().equals(userInternal.getId()));
		}
	}
