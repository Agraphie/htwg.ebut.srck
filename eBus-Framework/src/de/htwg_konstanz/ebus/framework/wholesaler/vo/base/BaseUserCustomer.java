...
/**
 * This is an object that contains data related to the user_customer table.
...
public abstract class BaseUserCustomer  implements Serializable {

	public static String REF = "UserCustomer";
	 ...
	 */
	public BaseUserCustomer (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof de.htwg_konstanz.ebus.framework.wholesaler.vo.UserCustomer)) return false;
		else {
			de.htwg_konstanz.ebus.framework.wholesaler.vo.UserCustomer userCustomer = (de.htwg_konstanz.ebus.framework.wholesaler.vo.UserCustomer) obj;
			if (null == this.getId() || null == userCustomer.getId()) return false;
			else return (this.getId().equals(userCustomer.getId()));
		}
	}
