...
/**
 * This is an object that contains data related to the fulfillmentinfoitem_customer table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="fulfillmentinfoitem_customer"
 */

public abstract class BaseFulfillmentinfoitemCustomer  implements Serializable {

	public static String REF = "FulfillmentinfoitemCustomer";
	...
	// constructors
	public BaseFulfillmentinfoitemCustomer () {
		initialize();
	}
	 ...
	 */
	public BaseFulfillmentinfoitemCustomer (de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemCustomerPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemCustomerPK id;
     ...
     * @hibernate.id
     */
	public de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemCustomerPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemCustomerPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemCustomer)) return false;
		else {
			de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemCustomer fulfillmentinfoitemCustomer = (de.htwg_konstanz.ebus.framework.wholesaler.vo.FulfillmentinfoitemCustomer) obj;
			if (null == this.getId() || null == fulfillmentinfoitemCustomer.getId()) return false;
			else return (this.getId().equals(fulfillmentinfoitemCustomer.getId()));
		}
	}
